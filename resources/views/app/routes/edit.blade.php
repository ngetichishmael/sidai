@extends('layouts.app')
{{-- page header --}}
@section('title', 'Route Schedule Editing')
{{-- page styles --}}
   ...
   <div class="content-header row">
      <div class="content-header-left col-md-12 col-12 mb-2">
         <div class="row breadcrumbs-top">
            <div class="col-12">
               <h2 class="content-header-title float-start mb-0">Route Schedule Editing</h2>
...
{{--               </div>--}}
               ...
               <div class="form-group mb-1">
                  <button class="btn" style="background-color: #ff8055;color:white" type="submit">Update Information</button>
               </div>
               {!! Form::close() !!}
            </div>
         </div>
