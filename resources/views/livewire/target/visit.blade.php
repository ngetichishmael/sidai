                ...
                <div class="pt-0 pb-2 d-flex justify-content-between align-items-center mx-50 row">
                 ...
                 <div class="col-md-6 d-flex justify-content-end">
                        <div class="demo-inline-spacing">
                            <a href="{{ route('visit.target.create') }}" class="btn btn-outline-secondary" style="background-color: brown;color:white">New Target</a>
                        ...
                        @forelse ($targets as $key=>$target)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td><a href="{{ route('visitstarget.edit', $target->user_code) }}" class="btn btn-outline-info btn-sm">Edit</a>
