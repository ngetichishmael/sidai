                            ...
                            @foreach ($surveries as $count => $survery)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                       ...
                                       <div class="dropdown" >
                                          <button style="background: #1B1570; color: white;" class="btn btn-md dropdown-toggle mr-2" type="button" id="dropdownMenuButton" data-bs-trigger="click" aria-haspopup="true" aria-expanded="false" data-bs-toggle="dropdown" data-bs-auto-close="outside">
