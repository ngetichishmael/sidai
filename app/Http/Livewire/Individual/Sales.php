...
use App\Charts\LeadsTargetChart;
...
class Sales extends Component
{
    ...
    public function render()
    {
        ...
        $salestargetEx = LeadsTargets::selectRaw('MONTH(created_at) as month, SUM(LeadsTarget) as total_sales_target, SUM(AchievedLeadsTarget) as total_sales_achieved')
            ->groupBy('month')
            ->get();
        ...
        $this->label = "Leads Target";
        $salestarget = new LeadsTargetChart();
        ...
        return view('livewire.individual.sales', [
