...
//      Route::get('/chat{key?}',Main::class)->name('chat');
   ...
   Route::get('customers/disapprove/list', ['uses' => 'app\customer\customerController@dispproved', 'as' => 'customer.disapproved']);
      ...
      Route::get('customer/details/{id}', ['uses' => 'app\customer\customerController@details', 'as' => 'creditor.details']);
      Route::get('creditor/details/{id}', ['uses' => 'app\customer\creditorController@details', 'as' => 'creditor.info']);
      Route::get('creditor/approve/{id}', ['uses' => 'app\customer\customerController@approvecreditor', 'as' => 'creditor.approve']);
      Route::get('customer/approve/{id}', ['uses' => 'app\customer\customerController@approvecustomer', 'as' => 'customer.approve']);
   /* === customer checkin === */
